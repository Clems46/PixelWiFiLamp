...
//End  
  ...
  Pal = LavaColors_p;
//Ajout pour mise à jour OTA
 // Hostname defaults to esp8266-[ChipID]
ArduinoOTA.setHostname("espLightWifi");
...
void loop() {
  ...
  //currentEffect = 0;    //Set le mode choisi manuelement
  changeAnimation();
  changeBrightness();
 ...
 */
  ...
  if (req.indexOf("/mode/0") != -1)
    val = 0;
  else if (req.indexOf("/mode/1") != -1)
    val = 1;
  else if (req.indexOf("/mode/2") != -1)
    val = 2;
  else if (req.indexOf("/mode/3") != -1)
    val = 3;  
  else if (req.indexOf("/mode/4") != -1)
    val = 4;
  else if (req.indexOf("/mode/5") != -1)
    val = 5;
  else if (req.indexOf("/mode/6") != -1)
    val = 6;
  else if (req.indexOf("/mode/7") != -1)
    val = 7;  
  else {
...
currentEffect = val;    //Set le mode choisi
